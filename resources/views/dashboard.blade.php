<x-app-layout>
        <section class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column pt-5">
                ...
                <img class="masthead-avatar my-3 animate__animated animate__pulse animate__slow animate__infinite"
                    src="{{ asset('images/market-launch-pana.svg') }}" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Bullet Journal</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Journaling is like whispering to one's self and listening at the same time.</p>
            </div>
        </section>
